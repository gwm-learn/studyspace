...
static const struct sc27xx_led_data sc2720_data = {
	.module_en = SC2720_MODULE_EN0,
	.clk_en = SC2720_CLK_EN0,
	.rgb_ctrl = SC2720_RGB_CTRL,
};
...
static int sc27xx_led_register(struct device *dev, struct sc27xx_led_priv *priv)
{
	...
	for (i = 0; i < SC27XX_LEDS_MAX; i++) {
		...
		led->ldev.default_trigger = "none"; /* Quectel modify */

		init_data.fwnode = led->fwnode;
		init_data.devicename = "sc27xx";
		init_data.default_label = ":";

		sc27xx_led_disable(led); /* Quectel add */
...
static const struct of_device_id sc27xx_led_of_match[] = {
	...
	{ .compatible = "sprd,sc2720-bltc", .data = &sc2720_data },
